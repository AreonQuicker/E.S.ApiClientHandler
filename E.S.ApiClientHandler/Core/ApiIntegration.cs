...
namespace E.S.ApiClientHandler.Core
{
    public class ApiIntegration : ApiIntegrationBase
    {
        ...
        public ApiIntegration(HttpClient client, string user, ILogger logger, IApiCachingManager cachingManager,
            int absoluteExpirationRelativeToNowInSeconds) : base(client, user, logger, cachingManager,
            absoluteExpirationRelativeToNowInSeconds)
        {
        }
        ...
        public ApiIntegration(string apiBaseUrl, string authorizationHeader, string user, ILogger logger,
            IApiCachingManager cachingManager, int absoluteExpirationRelativeToNowInSeconds) : base(apiBaseUrl,
            authorizationHeader, user, logger, cachingManager, absoluteExpirationRelativeToNowInSeconds)
        {
        }
    }
}